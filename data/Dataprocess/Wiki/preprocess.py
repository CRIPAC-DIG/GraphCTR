...
import pandas as pd
import math
train_path = '/mnt/dev_sdb1/lizekun/Wiki/wikipedia.csv'
f1 = open(train_path, 'r')
dic = {}
f_train_value = open('/mnt/dev_sdb1/lizekun/Wiki/train_x.txt', 'w')
f_train_index = open('/mnt/dev_sdb1/lizekun/Wiki/train_i.txt', 'w')
f_train_label = open('/mnt/dev_sdb1/lizekun/Wiki/train_y.txt', 'w')
debug = False
tune = False
Bound = [5] * 4
