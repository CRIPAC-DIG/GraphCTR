...
'''
import math
train_path = '/mnt/dev_sdb1/lizekun/track2/training.txt'
f1 = open(train_path, 'r')
f2 = open('/mnt/dev_sdb1/lizekun/track2/userid_profile.txt', 'r')
dic = {}
f_train_value = open('/mnt/dev_sdb1/lizekun/KDD2012/train_x.txt', 'w')
f_train_index = open('/mnt/dev_sdb1/lizekun/KDD2012/train_i.txt', 'w')
f_train_label = open('/mnt/dev_sdb1/lizekun/KDD2012/train_y.txt', 'w')
debug = False
tune = False
Column = 12
Field = 13
