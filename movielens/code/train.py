...
def parse_args():
    ...
    parser.add_argument('--ks', type=str2list, default=[7, 4], help='the size of sampled neighborhood')
    ...
    parser.add_argument('--k', type=int, default=4, help='keep the top k nodes')
...
def _run_(args, run_cnt):
    ...
    elif args.model_type == 'HOAFM':
        model = HOAFM(args=args, feature_size=feature_size, run_cnt=run_cnt)
    ...
    print(args.ks)
    # visualization = model.visualize(Xi_test, Xv_test, Xi_test_genre, Xv_test_genre, y_test)
